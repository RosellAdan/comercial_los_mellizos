            ...
            <div class="card">
                <table class="striped" cellspacing="0" width="100%">
                  ...
                  {{--                  <a href="{{ route('tipopersonal.show', [$tipopersonal->idp]) }}"><span class="new badge teal" data-badge-caption="ver"></span></a>--}}
                                    <a href="{{ route('proveedor.edit', [$proveedor->codip]) }}"><span class="new badge teal" data-badge-caption="Editar"></span></a>
                                    <a href="{{ route('proveedor.destroy', [$proveedor->codip]) }}"><span class="new badge teal" data-badge-caption="Eliminar"></span></a>
